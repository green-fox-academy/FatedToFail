...
You have:        ${money}$ on your account
                 ...
                 ${myCarrier.aircrafts.filter(e => e.type === 'F16').length} pc(s) F16 Aricraft Fighter  ammo: 10           (cost: 2000$)  /-buyF16/
                 ${myCarrier.aircrafts.filter(e => e.type === 'F35').length} pc(s) F35 Aricraft Fighter  ammo: 14           (cost: 3000$)  /-buyF35/
